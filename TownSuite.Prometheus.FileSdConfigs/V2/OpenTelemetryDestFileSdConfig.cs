...
public class OpenTelemetryDestFileSdConfig : DestFileSdConfig
{
    public OpenTelemetryDestFileSdConfig(AppSettings appSettings, ILogger logger, Settings setting, Client client) : base(
    ...
    protected override void AttributeParsing(ServiceInfo serviceInfo)
    {
        ...
        {
            if (string.Equals(attr.Key, "OpenTelemetryUrl", StringComparison.InvariantCultureIgnoreCase))
            {
